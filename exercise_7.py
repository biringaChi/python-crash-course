...
"""
Q.7-3. Multiples of Ten: Ask the user for a number, and then report
...
"""
Q.7-4. Pizza Toppings: Write a loop that prompts the user to enter a series
...
"""
Q.7-5. Movie Tickets: A movie theater charges different ticket prices
...
"""
Q.7-6. Three Exits: Write different versions of either Exercise 7-4
...
"""
Q.7-8. Deli: Make a list called sandwich_orders and fill it
with the names of various sandwiches . Then make an empty list called finished_sandwiches .
...
"""
Q.7-9. No Pastrami: Using the list sandwich_orders from Exercise 7-8,
...
the deli has run out of pastrami, and then use a while loop to remove all occurrences
...
"""
Q.7-10. Dream Vacation: Write a program that polls users about their dream vacation.
